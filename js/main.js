...
const clearAllCompletedTasksBtn = document.querySelector("button#clear-all-completed-tasks")
...
function showTasksList() {
  ...
  if (list.length === 0) {
    ...
    clearAllCompletedTasksBtn.disabled = !list.filter(t => t.completed).length > 0
